...
<tr>
  <th><a href = "https://github.com/Stuksus/HW1_ML1_Pandas">Работа с библиотеками по обработке данных</a></th>
  <th>Машинное обучение 1</th>
  <th>В первом разделе необходимо выполнить базовые задания с помощью указанных библиотек, а во втором распределить студентов по специализациям, основываясь на их перцентиль.</th>
  <th>Завершен</th>
</tr> 
</table>
</details>
